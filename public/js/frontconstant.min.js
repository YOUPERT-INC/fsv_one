...
var urlserverlink = "http://localhost:3001/api/";
var urlserverlinkhtml = "http://localhost:3001/";
// var urlserverlink = "http://local.websoptimization.com:8081/api/";
// var urlserverlinkhtml = "http://local.websoptimization.com/node_api/fsv-online/";
var urlhome = "";
...
if (!getlang) {
  ...
  // use case H3 tag url
  var urlcaselink = "#";
  var h3ttltxt1 = "1. Dowload API player app for each OS. You can also visit";
  var h3ttltxt2 = "for the latest version.";
  var h3urlttl = "apiplayer.app";
  var h3tag = '<h3 id="usecasettl5">'+ h3ttltxt1 +' <a href="https://apiplayer.app" id="usecasettl6" target="_blank">'+ h3urlttl +'</a> '+ h3ttltxt2+'  </h3>';
  $("#append-h3").append(h3tag);
...
else
{
  ...
  else
  {
    // use case H3 tag url
    var urlcaselink = "#";
    var h3ttltxt1 = "1. 본인의 운영체제에 맞는 API player 앱을 다운받으세요.";
    var h3ttltxt2 = "에서 다운받아도 됩니다";
    var h3urlttl = "개발자 홈페이지";
    var h3tag = '<h3 id="usecasettl5">'+ h3ttltxt1 +' <a href="https://apiplayer.app" id="usecasettl6" target="_blank">'+ h3urlttl +'</a> '+ h3ttltxt2+'  </h3>';
    $("#append-h3").append(h3tag);
